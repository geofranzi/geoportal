...
class InpireLayer(Layer):
    ...
    responsible_city_department = models.ForeignKey(Contact, related_name="city_department", limit_choices_to= Q(organisation__startswith="Stadt Hameln"))
    type = models.TextField(max_length=20, choices=[('intern', 'intern'), ('OpenData', 'OpenData'), ('INSPIRE', 'INSPIRE')], default="intern")
    status = models.TextField(max_length=20, choices=[('ongoing', 'ongoing'), ('completed', 'completed')], default="ongoing")
