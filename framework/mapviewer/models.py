...
class BaseLayer(models.Model):
    ...
    type = models.CharField(max_length=10,
                            choices=[('BingMaps', 'BingMaps'), ('WMS', 'WMS'), ('WMTS', 'WMTS'), ('XYZ', 'XYZ'), ('MapQuest', 'MapQuest'), ('OSM', 'OSM')])
...
class MapViewer(models.Model):
    ...
    template_file = models.FilePathField("Template file", path=settings.TEMPLATES[0]['DIRS'][0] + '/mapviewer', match=".*\.html", max_length=1000)  # noqa: W605
    ...
    addexternallayer = models.BooleanField("Allow external layers", default=False,
                                           help_text="(Hint: If activated, the button for add external layers to map by users is not hidden.)")
    ...
    map_proj = models.CharField("Map projection", max_length=15, default="EPSG:4326",
                                help_text=("EPSG projection code (e.g. EPSG:3857 - WGS84 Web Mercator, used in many popular "
                                           "web mapping applications (GoogleMaps/OpenStreetMap/etc))"))
    ...
    time_slider_interval = models.CharField("Step interval", max_length=100, choices=[('year', 'year'), ('month', 'month'),
                                                                                      ('week', 'week'), ('day', 'day')], blank=True, null=True)
